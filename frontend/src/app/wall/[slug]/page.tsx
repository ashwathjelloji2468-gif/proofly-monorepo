...
export default function PublicWallShowcasePage() {
  ...
  // Inject structured JSON-LD schema review list
  const jsonLdSchema = {
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        <div className={`grid grid-cols-3 gap-4 border p-6 rounded-2xl shadow-md ${isDark ? 'bg-[#141417] border-border-primary' : 'bg-slate-50 border-zinc-200'}`}>
          <div className="text-center space-y-1">
            <span className="text-[10px] uppercase font-bold text-slate-450 tracking-wider">Average Rating</span>
          ...
          <div className="text-center space-y-1 border-x border-border-primary/50">
            <span className="text-[10px] uppercase font-bold text-slate-450 tracking-wider">Total Reviews</span>
            <div className={`text-2xl font-black ${isDark ? 'text-white' : 'text-slate-900'}`}>{totalReviews}</div>
          </div>
          <div className="text-center space-y-1">
            <span className="text-[10px] uppercase font-bold text-slate-450 tracking-wider">Video Reviews</span>
              ...
              <div
                ...
                className={`border p-5 rounded-2xl shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer flex flex-col justify-between ${
                  isDark 
                    ...
                    : 'bg-slate-50 border-zinc-150 hover:border-zinc-350'
                }`}
              >
