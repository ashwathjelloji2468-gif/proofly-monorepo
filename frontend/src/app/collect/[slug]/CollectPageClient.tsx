                ...
                {mode === 'video' && (
                  <div className="space-y-4">
                    {videoURL ? (
                      ...
                      <div className="bg-black border border-zinc-855 rounded-2xl overflow-hidden p-4 relative">
        ...
        {step === 5 && (
          <div className="text-center space-y-6 py-6">
            ...
            {currentCollectionPage.redirectUrl && (
              <p className="text-[10px] text-brand-teal font-bold animate-pulse">Redirecting you in a few seconds...</p>
            )}
